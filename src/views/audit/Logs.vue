<template>
  <div class="audit-logs">
    <header class="page-header">
      <h1>Audit Logs</h1>
      <p>Detailed log of all system activities</p>
    </header>

    <div class="filters-bar">
      <select v-model="filters.module" class="filter-select" @change="fetchLogs">
      ...
      <input type="text" v-model="filters.search" placeholder="Search user..." class="filter-input" @change="fetchLogs" />
    ...
    <div v-if="totalPages > 1" class="pagination">
      <button @click="prevPage" :disabled="currentPage === 1" class="btn btn-outline">Previous</button>
      <span>Page {{ currentPage }} of {{ totalPages }}</span>
      <button @click="nextPage" :disabled="currentPage === totalPages" class="btn btn-outline">Next</button>
    </div>
  </div>
</template>
